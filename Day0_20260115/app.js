...
const dailyFolders = [
    ...
    {
        id: 'Day0-5',
        dir: '5_AutoPostingSystem',
        logFile: './5_AutoPostingSystem/Log.md',
        date: '2026-01-15',
        topic: 'Auto-Posting System',
        post: '自動投稿システム配管完了。GitHub Actions 連動。',
        ok_to_post: true,
        media: {
            video: 'media/dashboard_features_summary.gif',
            screenshot: 'media/ga_workflow_v3.png'
        }
    },
    {
        id: 'Day0-6',
        dir: '6_DeploymentSharing',
        logFile: './6_DeploymentSharing/Log.md',
        date: '2026-01-15',
        topic: 'Deployment & Sharing',
        post: 'GitHub Pages デプロイ準備と共有リンク機能の実装。',
        ok_to_post: true,
        media: { video: 'media/sharing_demo.gif', screenshot: 'media/gh_pages_setup.png' }
    }
];
