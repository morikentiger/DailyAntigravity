// Day 10 Dashboard - Platformer Base

const dailyFolders = [
    {
        name: '1_PlatformerBase',
        title: '🧱 Platformer Engine Base',
        description: 'マリオ再現プロジェクトの第一歩！',
        logPath: '1_PlatformerBase/Log.md',
        appPath: '1_PlatformerBase/index.html',
        mediaPath: '1_PlatformerBase/media/gameplay.mp4'
    }
];
