// Day 8 Dashboard - Winding Path Race

const dailyFolders = [
    {
        name: '1_WindingRace',
        title: '🏎️ Winding Path Race',
        description: '細い道をくねくね進む！',
        logPath: '1_WindingRace/Log.md',
        appPath: '1_WindingRace/index.html',
        mediaPath: '1_WindingRace/media/gameplay.mp4'
    }
];
